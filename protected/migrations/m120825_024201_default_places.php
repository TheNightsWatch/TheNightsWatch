...
class m120825_024201_default_places extends CDbMigration
{
    public function safeUp()
    {
        ...
        $this->insert('place',array('type' => 'DUNGEON', 'name' => 'Anemos Sanctum', 'x' => 256, 'y' => 80, 'z' => -3644));
        ...
        $this->insert('place',array('type' => 'MAJOR', 'loot' => 6, 'name' => 'Bell Farm', 'x' => 822, 'y' => 70, 'z' => 383));
        ...
        $this->insert('place',array('type' => 'MAJOR', 'loot' => 2, 'name' => 'Abandoned Farm', 'x' => 1065, 'y' => 70, 'z' => -2905));
        ...
        $this->insert('place',array('type' => 'MINOR', 'name' => 'Tiocenora & Co Quarry', 'x' => -2294, 'y' => 70, 'z' => -2672));
        ...
        $this->insert('place',array('loot' => 2, 'type' => 'TOWN', 'name' => 'Al Hasa', 'x' => 1582, 'y' => 70, 'z' => -3121));
